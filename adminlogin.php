  ...
  <section class="container-fluid">
    <section class="row justify-content-center">
      <section class="col-12 col-sm-6 col-md-4">
        <form class="form-container" action="adminRegistration1.php" method="post">
        ...
        <button type="submit" class="btn btn-primary btn-block" style="background-color: orange;">Submit</button>
